...
class Activity_Model extends Model
{
	...
	public static function getActivitiesByCategory($category_id) {
		$data = DB::select('SELECT pa.activity_id, pa.activity_name, pa.price, pa.details, pa.address, pa.traffic, pa.hours, pa.must_know, pa.created_at, pa.rect_img, pa.sq_img
