...
//// -----------------------------------
 public function filterSearch(Request $request) {
        ...
        // get relevant activities via category_id
        if (isset($_GET["category_id"])) {
            $category_id = ($_GET["category_id"] != '-') ? $_GET["category_id"] : NULL;
            $activity = Search_Model::getActivityViaCategoryID($category_id);
        } else {
            $activity = NULL;
        }

        foreach($activity as &$profile) {
        ...
        return response()->json(array('success' => true, 'data' => $activity));
    }
//// -----------------------------------   
    ...
    //     $search_result = Search_Model::filterSearch($user_id, $gender, $ageFrom, $ageTo, $priceRange = NULL, $date, $venue = NULL, $category_id);
